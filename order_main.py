...
#for encoding binary data to printable ASCII characters and decoding it  
# #back to binary form
import base64 

st.set_page_config(
        page_title="Package Order Forecasting",
        page_icon="page_icon.png"
    )

image = Image.open('delivery.jpg')
st.image(image, caption='Package Delivery', width=300)
st.markdown("<h1 style='text-align: right; color: red;'delivery.jpg", unsafe_allow_html=True)


streamlit.write('IMPORT DATA')
